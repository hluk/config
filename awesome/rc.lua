...
mytextclock = awful.widget.textclock(" <span font='Aller Display 6'>%a %b %d</span> <span font='Aller Display 11'>%H:%M</span> ")
...
globalkeys = awful.util.table.join(
    ...
    --awful.key({ modkey,           }, "e", function () mymainmenu:show({keygrabber=true}) end),
    ...
    awful.key({ modkey, "Control"    }, "e",
              function ()
                  awful.util.spawn(
                    "gvim -O " .. awful.util.getdir("config") .. "/rc.lua " .. awful.util.getdir("config") .. "/theme.lua")
              end),
